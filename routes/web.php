...
Route::get('manage-avatar', [UserController::class, 'showAvatarForm'])->name('manage-avatar');
Route::post('/manage-avatar', [UserController::class, 'storeAvatar'])->name('store-avatar');
